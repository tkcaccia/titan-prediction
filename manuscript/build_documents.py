...
add_figure(doc, "Figure6_site_grouped_sensitivity.png", "Figure 6. Sensitivity to TCGA tissue-source-site-code grouping as a principal result. Panel A compares all 323 random-fold estimates with estimates grouped by TCGA tissue-source-site code; Panel B shows the eight largest attenuations; Panel C shows the 15 strongest chance-normalised within-cancer code-classification results. Larger typography and restricted ranked panels improve readability. This grouping remains internal to TCGA; the code is not an institutional, scanner or laboratory identifier, and the analysis is not external validation.")
