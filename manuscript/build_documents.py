...
credit_statement = (
    "Aamilah Ismail: Data curation, Formal analysis, Investigation, Methodology, "
    "Software, Validation, Visualization, Writing - original draft, Writing - "
    "review and editing. Martin Ocharo: Data curation, Formal analysis, "
    "Investigation, Methodology, Software, Validation, Visualization, Writing - "
    "original draft, Writing - review and editing. Moussa Kassim: Data curation, "
    "Investigation, Validation, Writing - review and editing. Dalia Ahmed: Data "
    "curation, Investigation, Validation, Writing - review and editing. Brendon "
    "Price: Investigation, Validation, Writing - review and editing. Dupe Ojo: "
    "Data curation, Investigation, Validation, Writing - review and editing. "
    "Ekene Emmanuel Nweke: Investigation, Validation, Writing - review and "
    "editing. Silvano Piazza: Methodology, Software, Validation, Writing - review "
    "and editing. Dinesh Gupta: Methodology, Supervision, Validation, Writing - "
    "review and editing. Alessia Vignoli: Methodology, Validation, Writing - "
    "review and editing. Leonardo Tenori: Conceptualization, Methodology, "
...
responses.append((
    ...
    "Addressed. We rebuilt Additional file 1 as a compact interpretive companion. It retains Tables S1-S18 but limits long target-level displays to small summaries, removes redundant target-level ridge, morphology, selected-example, TITAN-atlas, multi-outcome and duplicate COAD figures, and reduces the visual inventory from 13 to six figures. Complete per-model, per-fold and target-level records remain in the synchronized CSV and RDS companions listed in the final inventory. The opening contents section now explains this division. We audited the 42-item bibliography and cite every retained reference in scientific context. Reference 35 keeps the unusual surname spelling Lamrca because PubMed PMID 35039450 and the canonical journal record list Angela Lamrca; the reference now gives the complete author list. The Additional-file section names supplementary_material_JTM.docx and both PathoFMPred PDFs exactly, and the build verifies that the files exist. Figure 1 now labels the three released patient and slide counts and the 10,165-slide exact common intersection; all figures keep TITAN blue, Giga-SSL orange and Prov-GigaPath green. The declarations report no competing interests, no specific grant and complete CRediT contributions. The final source-release tag and DOI remain intentionally deferred at the authors' request."
))
responses.append((
...
final_responses = [
    ...
    (
        ...
        "competing-interest, funding and CRediT statements are now complete. The "
        "source-release DOI or immutable archive identifier remains intentionally "
        "deferred at the authors' request."
    ),
]
