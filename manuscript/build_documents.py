...
doc.add_heading("Research-software interface and COAD radar illustration", level=2)
doc.add_paragraph(
    ...
    f"{len(binary_limited_reliability)} limited-evidence binary models require explicit opt-in. Every binary display uses the adjacent label 'TCGA OOF score rank (not probability)' and places training positive/negative counts, prevalence, "
