...
if highlighted:
    ...
    for r in h_cont:
        ...
        performance_rows.append((r["tumor_type"] + "–" + r["endpoint"],
                                 f'Q² {fnum(r.get("primary_screen_q2"))}',
    ...
    for r in h_bin:
        ...
        if site_status.startswith("site-sensitive"):
            site_status = "WARNING: " + site_status.replace("site-sensitive: ", "")
        performance_rows.append((r["tumor_type"] + "–" + r["endpoint"],
                                 f'BA {fnum(r.get("primary_screen_balanced_accuracy"))}',
    ...
    add_table(doc, ["Cancer–endpoint", "Primary screen Q²/BA", "Five-repeat Q² or Se/Sp (95% SC interval)", "Five-repeat RMSE or BA (95% SC interval)", "Five-repeat Spearman or AUROC (95% SC interval)", "TSS-grouped metric/status"], performance_rows)
