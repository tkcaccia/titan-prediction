...
doc.add_paragraph("Supplementary methods, Tables S1–S14, Figures S1–S4 and the machine-readable-file inventory are provided in Additional file 1. The two illustrative single-sample TITANPred reports are supplied separately as Additional files 2 and 3.")
