...
doc.add_paragraph(
    ...
    + ". ACC, CHOL, DLBC, MESO and UCS had fewer than two codes meeting the 10-patient requirement and were reported as ineligible. This result shows substantial information associated with TCGA tissue-source-site code in the fixed TITAN representation and strengthens the confounding concern; it does not identify a causal scanner, laboratory or staining effect."
)
