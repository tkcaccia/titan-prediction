...
site[, site_robustness_status := fcase(
  ...
  !site_retained_effect, "site-sensitive: below original documented screening threshold",
  default = "retained original documented screening threshold"
)]
site[, site_robustness_warning := fcase(
  ...
  "Site-sensitivity warning: performance fell below the original documented screening threshold under TCGA tissue-source-site grouping.",
  default = ""
)]
